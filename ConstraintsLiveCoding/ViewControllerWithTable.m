...
-(void)createSampleData {
    self.sampleData = @[@"Some text.",
                        @"Lots of text that wraps and wraps and wraps a", @"There’s nothing worse than being stuck by yourself on a big holiday while everyone else is throwing parties. It can even happen to famous basketball players, like Jazz star Donovan Mitchell. When Mitchell was left without Fourth of July plans, he put out a call on Twitter.",
                        @"Some text",
                        @"More text."];
}
